...
"""
import numpy as np
from _common import bench_us, mp_spectrum
...
def main():
    ...
    for n_points in [50, 100, 200, 400, 800]:
        ...
        us = bench_us(lambda: rk.deconvolve_spiked(evals.copy(), 0.5, n_points, eta, 1.0),
                   n_runs=n_runs)
    ...
    for p in [100, 500, 1000, 2000]:
        ...
        us = bench_us(lambda: rk.deconvolve_spiked(ev.copy(), 0.5, 200, eta_p, 1.0),
                   n_runs=n_runs)
